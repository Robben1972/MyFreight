...
#search handlers
dp.message.register(search.search_select_type, StateFilter("search:select_type"))  # Added back this line
...
# Added new handlers for trailer type selection after region
dp.message.register(search.search_trailer_type_after_region, StateFilter("search:trailer_type_after_region"))
dp.message.register(search.search_trailer_type_after_region_vehicle, StateFilter("search:trailer_type_after_region_vehicle"))
